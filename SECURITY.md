...
- **Preferred:** Use GitHub's
  [private vulnerability reporting](https://github.com/pquarterman17/fermiviewer/security/advisories/new) —
...
FermiViewer is local analysis software — a FastAPI backend bound to
`127.0.0.1` serving a local single-page app. The attack surface that matters
most:
