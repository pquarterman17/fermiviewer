...
|---|---|---|---|
| SPECTRAL_WORKSPACE_PLAN.md | EDS+EELS shared spectrum core, species lists, batch maps, composites, synthetic-SI verification | Active (13 open items / 9 sub-task boxes, W1–W4) | Independent lifecycle, four workstreams of its own |
